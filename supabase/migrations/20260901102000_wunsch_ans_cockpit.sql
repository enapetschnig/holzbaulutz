-- Änderungswünsche ins CRM weiterleiten (app.epowergmbh.at → "Wünsche").
--
...
-- privaten Bucket; das CRM holt bei Bedarf eine signierte URL bei der Edge
-- Function `wunsch-datei` — beides über dasselbe gemeinsame Geheimnis.
--
-- Der Trigger ist inaktiv, solange `cockpit_verbindung` leer ist. Diese
...
CREATE TABLE IF NOT EXISTS public.cockpit_verbindung (
  ...
  app_key   text NOT NULL DEFAULT 'holzbaulutz'
);
