...
export default function Customers() {
  ...
  const openEdit = (c: Customer) => {
    ...
    setForm({
      ...
      // Altkunden ohne gespeicherten Typ: geschäftlich NUR mit UID, sonst privat
      kundentyp: (c as any).kundentyp || (((c as any).uid_nummer || "").trim() ? "geschaeftskunde" : "privatkunde"),
  ...
  const handleSave = async () => {
    ...
    try {
      const payload: any = {
          ...
          kundentyp: form.kundentyp || ((form.uid_nummer || "").trim() ? "geschaeftskunde" : "privatkunde"),
